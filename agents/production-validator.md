...
description: Production validation specialist ensuring applications are fully implemented and deployment-ready. Use before shipping to confirm no mock/stub implementations, missing env vars, or untested integrations remain.
---
