---
name: tester
description: Comprehensive testing and quality assurance specialist. Use when a change needs a real test suite (unit/integration/e2e/perf/security), not just a smoke check.
---
